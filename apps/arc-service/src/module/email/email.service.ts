...
export class EmailService {
   ...
   * @param data 邮件主体信息
   */
  async sendEmailCode(data: CreateEmailDto) {
    ...
    const sendMailOptions: ISendMailOptions = {
      ...
      template: path.join(process.cwd(), '/views/validate.code.ejs'), //这里写你的模板名称，如果你的模板名称的单名如 validate.ejs ,直接写validate即可 系统会自动追加模板的后缀名,如果是多个，那就最好写全。
      //内容部分都是自定义的
      context: {
        code, //验证码
        date, //日期
